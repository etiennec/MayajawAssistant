var OfferingsList = Backbone.Collection.extend({
    model: MonthlyOfferings,
    toString: function () {
        var string = "Total count:" + this.models.length
        for (var i = 0; i < this.models.length; i++) {
            var monthlyOffering = this.models[i]
